...
function palindrome(str) {
  const formatStr = str.replace(/[,;:\-.!\?()'"\s]/g, '').toUpperCase();
  const reverseFormatStr = [...formatStr].reverse().join('');
  return formatStr === reverseFormatStr;
}
...
console.log(palindrome('тоПот(тот):-Топот?!')) // true
